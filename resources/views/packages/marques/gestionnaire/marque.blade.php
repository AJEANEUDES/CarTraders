...
<div class="modal fade" id="updateMarqueModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('marques-voitures.update.gestion') }}" method="post" id="marques-voitures-update-gestion">
                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('marques-voitures.delete.gestion') }}" method="post" id="marques-voitures-delete-gestion">
                    @csrf
...
@include('packages.marques.gestionnaire.marqueModal')
@endsection
...
<script>
    ...
    $(document).on('click', '#updateMarque', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('marques.info.gestion') }}',
            dataType: 'JSON',
