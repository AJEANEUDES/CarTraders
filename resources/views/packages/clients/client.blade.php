    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body row g-3">
                ...
                <div class="col-md-6 text-center">
                    <span>Prenom</span>
                    <div style="font-weight: 600;text-transform: uppercase;" id="viewPrenomClient"></div>
                </div>
                <div class="col-md-6 text-center">
                    <span>Email</span>
...
<script>
    ...
    $(document).on('click', '#updateClient', function(){
        ...
        $.ajax({
            ...
            success: (response)=>{
                ...
                $(".update-client").html('<input type="hidden" name="id_client" value="'+response.id+'">');
    ...
    $(document).on('click', '#getInfosClient', function(){
        ...
        $.ajax({
            ...
            success: (response)=>{
                ...
                $("#viewPrenomClient").html(response.prenom_user);
    ...
    $(document).on('click', '#deleteClient', function(){
        ...
        $.ajax({
            ...
            data: {id_client:id_client},
            success: (response)=>{
                $("#viewMessageDeleteClient").html('Etes-vous sur de vouloir supprimer le client <strong>'+response.nom_user+' '+response.prenom_user+'</strong>?');
                $("#formDeleteClient").html('<input type="hidden" name="id_client" value="'+response.id+'"> <button type="submit" style="border-radius: 10px;" class="btn btn-danger btn-md"><i class="bx bx-trash"></i> Oui</button>');
