            ...
            <div class="card">
                <div class="card-body" style="overflow: auto;">
                    <h5 class="card-title" style="text-align: center;font-size: 25px;">Enregistrement des images de
                        voitures</h5>
                    <form action="{{ route('images-voitures.store') }}" method="post" enctype="multipart/form-data"
                        id="images-voitures-store">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="voiture" class="form-control form-control-lg" id="voiture">
                                    ...
                                    <option value="{{ $voiture->id_voiture }}">
                                        {{ $voiture->nom_marque }} {{ $voiture->nom_modele }} - (Parking: {{
...
<div class="modal fade" id="updateImageModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('images-voitures.update') }}" method="post" enctype="multipart/form-data" id="images-voitures-update">
                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('images-voitures.delete') }}" method="post" id="images-voitures-delete">
                    @csrf
...
<script>
    ...
    $(document).on('click', '#updateImage', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('images-voitures.info') }}',
            dataType: 'JSON',
