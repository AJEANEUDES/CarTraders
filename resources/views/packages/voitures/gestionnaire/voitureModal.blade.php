<form action="{{ route('voitures.store.gestion') }}" method="post" enctype="multipart/form-data" id="voitures-store-gestion">
    @csrf
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select style="height: 55px;border-radius: 10px;" class="form-control form-control-lg"
                            ...
                            <option value="{{ encodeId($parkings->id_parking) }}">{{ Str::upper($parkings->nom_parking) }}
                            </option>
                            {{-- @endforeach --}}
                        </select>
                    </div>
