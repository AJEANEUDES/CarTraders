...
<div class="modal fade" id="updateModeleModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('modeles-voitures.update') }}" method="post" id="modeles-voitures-update">
                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('modeles-voitures.delete') }}" method="post" id="modeles-voitures-delete">
                    @csrf
...
@include('packages.modeles.admin.modeleModal')
@endsection
