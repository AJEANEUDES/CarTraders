...
<section class="newsletter section">
    <div class="newsletter__container container">
        ...
        <form action="{{ route('inscriptions.clients') }}" method="post" class="contact__form grid" id="inscriptions-clients">
            @csrf
            <div class="contact__inputs grid">
                ...
                <div class="contact__content">
                    ...
                    <input type="text" name="prenom_user" id="prenom_user" class="contact__input" />
                </div>
            </div>
            ...
            <div class="contact__inputs grid">
                ...
                <div class="contact__content">
                    <label for="adresse_user" class="contact__label">Adresse de residance</label>
