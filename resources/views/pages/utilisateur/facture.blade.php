        ...
        <div class="sidebar">
            ...
            <div class="filter__content">
                ...
                <div class="filter" style="cursor: pointer;">
                    <i style="font-size: 22px;" class="bx bx-chevron-right"></i>
                    <p style="font-size: 20px;">
                        <a href="{{ route('factures.liste') }}" style="color: #A40000;">Mes factures</a>
                    </p><span></span>
                </div>
                <div class="filter" style="cursor: pointer;">
                    <i style="font-size: 22px;" class="bx bx-chevron-right"></i>
            ...
            <table class="table datatable">
                <thead>
                    <tr style="text-align: center;">
                        ...
                        <th scope="col" style="padding: 20px;">VOITURE</th>
                ...
                <tbody>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td scope="row" style="padding: 0 20px 0 20px;">{{ $mes_facture->nom_marque }} {{ $mes_facture->nom_modele }}</td>
