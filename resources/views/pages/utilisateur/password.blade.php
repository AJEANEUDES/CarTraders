...
<section class="shop section container">
    ...
    <div class="shop__container grid">
            ...
            <div class="filter__content">
                <div class="filter" style="cursor: pointer;">
                    ...
                    <p style="font-size: 20px;">
                        <a href="{{ route('utilisateur.profile') }}">Mon compte</a>
                    </p><span></span>
                </div>
                <div class="filter" style="cursor: pointer;">
                    <i style="font-size: 22px;" class="bx bx-chevron-right"></i>
        ...
        <form action="{{ route('utilisateur.update.mdp') }}" method="post" class="contact__form grid" id="utilisateur-update-mdp">
            @csrf
            <input type="hidden" name="id_client" value="{{ encodeId($client->id) }}">
            ...
            <div class="contact__inputs">
                ...
                <div class="contact__content">
                    <label for="confirmation_password" class="contact__label">Retaper le mot de passe</label>
