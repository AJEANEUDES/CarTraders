...
<footer class="footer section">
    <div class="footer__container container grid">
        ...
        <div class="footer__content">
            <a href="javascript:void(0)" class="footer__logo">
                <i class="bx bxs-car footer__logo-icon"></i>Mycartraders
            </a>
            <p class="footer__description">Plateforme de vente de voiture d'occasion.</p>
        ...
        <div class="footer__content">
            ...
            <ul class="footer__links">
                <li><a href="{{ route('inscription.view') }}" class="footer__link">S'inscrire</a></li>
                <li><a href="{{ route('login') }}" class="footer__link">Se connecter</a></li>
            </ul>
        </div>
        ...
        <div class="footer__content">
            ...
            <ul class="footer__links">
                <li><a href="{{ route('acheter.voiture.get') }}" class="footer__link">Acheter une voiture</a></li>
    ...
    <span class="footer__copy">&#169; mycartraders. Tous les droits sont réservés</span>
</footer>